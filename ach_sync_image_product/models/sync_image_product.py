...
class SyncImageProductFields(models.Model):
    ...
    ttype_import = fields.Selection([
        ...
        # Field types added to Odoo core since this list was first written (11.0-16.0) — kept here so
        # "Logging" doesn't crash when the remote product model has a field of one of these newer types.
        ('json','json'),('properties','properties'),('properties_definition','properties_definition')],
        string="Type Import")
